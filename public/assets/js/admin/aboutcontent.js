...
async function initEditors() {
    ...
    function showToast(type, title, msg) {
        ...
        // if (!el) return;
        if (!el) { console.warn('Toast element #ecToast not found in DOM'); return; }
    ...
    function fillForm(r) {
        ...
        showImagePreview(
            "previewAboutImg1",
            "thumbAboutImg1",
            r.about_section_img1_url || null,
        );
        showImagePreview(
            "previewAboutImg2",
            "thumbAboutImg2",
            r.about_section_img2_url || null,
        );
        showImagePreview(
            "previewWhyImg",
            "thumbWhyImg",
            r.why_section_image_url || null,
        );
    }
    ...
    async function loadRecord() {
        ...
        try {
            ...
            if (record && record.id) {
                fillForm(record);
                document.getElementById("abcSaveBtnText").textContent =
                    "Update";
            } else {
                resetForm();
            ...
            document
                .getElementById("abcFormContainer")
