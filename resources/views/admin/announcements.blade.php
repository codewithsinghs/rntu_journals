...
@section('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadAnnouncements(page = 1) {
                ...
                fetch(`/api/admin/announcements?page=${page}`, {
                    ...
                    .then(res => {
                        if (!res.status) {
                            tbody.innerHTML =
                                `<tr><td colspan="7" class="text-center text-danger py-4">Failed to load announcements.</td></tr>`;
                            return;
                        }
                    ...
                    .catch(() => {
                        tbody.innerHTML =
                            `<tr><td colspan="7" class="text-center text-danger py-4">Something went wrong.</td></tr>`;
                    });
            }
            ...
            function setLinkDisabled(linkEl, linkWrapper, fileEl, fileWrapper, disabled) {
                linkEl.disabled = disabled;
                linkWrapper.style.opacity = disabled ? '0.45' : '1';
                if (disabled) linkEl.value = '';
            }

            function setFileDisabled(fileEl, fileWrapper, linkEl, linkWrapper, disabled) {
            ...
            document.getElementById('addAnnouncementModal')
                .addEventListener('hidden.bs.modal', function() {
                    ...
                    document.getElementById('add_attachment_wrapper').style.opacity = '1';
                });
            ...
            document.getElementById('editAnnouncementModal')
                .addEventListener('hidden.bs.modal', function() {
                    ...
                    document.getElementById('edit_current_attachment').classList.add('d-none');
                });
            ...
            window.openEdit = function(id, name, link, sequence, attachment) {
                ...
                const currentAttachDiv = document.getElementById('edit_current_attachment');
                const currentAttachLink = document.getElementById('edit_attachment_link');
                if (attachment) {
                ...
                if (link && link.trim() !== '') {
                    ...
                    document.getElementById('edit_attachment_wrapper').style.opacity = '0.45';
                } else if (attachment) {
            ...
            document.getElementById('addForm').addEventListener('submit', function(e) {
                ...
                fetch('/api/admin/announcements', {
                    ...
                    .then(res => {
                        ...
                        if (res.status) {
                            bootstrap.Modal.getInstance(document.getElementById('addAnnouncementModal'))
                                .hide();
                            showToast(res.message, 'success');
                            loadAnnouncements(currentPage);
                        } else {
                            const errors = res.errors ? Object.values(res.errors).flat().join(' ') : res
                                .message;
            ...
            document.getElementById('confirmDeleteBtn').addEventListener('click', function() {
                ...
                fetch(`/api/admin/announcements/${deleteId}`, {
                    ...
                    .then(res => res.json())
                    .then(res => {
                        bootstrap.Modal.getInstance(document.getElementById('deleteAnnouncementModal'))
                            .hide();
                        if (res.status) {
                            showToast(res.message, 'success');
                            loadAnnouncements(currentPage);
