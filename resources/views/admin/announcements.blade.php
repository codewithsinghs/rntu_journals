            ...
            <form id="addForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="bottom-btn">
                        ...
                        <button type="submit" class="green" id="edit-submit-btn">
                            <span id="edit-spinner" class="spinner-border spinner-border-sm d-none" role="status" aria-hidden="true"></span>
                            <span id="edit-btn-text">Save</span>
                        </button>
                    </div>
