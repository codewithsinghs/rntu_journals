...
@section('scripts')
    <script>
        ...
        let uploadModal, editModal, confirmDeleteModal, deleteSuccessModal, saveSuccessModal;
        ...
        function loadMedia() {
            fetch(API, {
                ...
                .then(data => {
                    ...
                    allMedia = (data.data && data.data.data) ? data.data.data : (data.data || []);
        ...
        function applyFilterAndRender() {
            ...
            filteredMedia = query ?
                allMedia.filter(m => (m.original_name || '').toLowerCase().includes(query)) :
                allMedia;
            renderTable();
            renderPagination();
        }
        ...
        function fileIconClass(mimeType) {
            ...
            if (mimeType.includes('presentation')) return 'bi-file-earmark-ppt text-warning';
        ...
        function handleUploadFile(file) {
            ...
            document.getElementById("uploadDropZoneText").innerHTML =
                '<i class="bi bi-file-earmark-check text-success me-1"></i>' + escapeHtml(file.name);
        ...
        function openUploadModal() {
            ...
            resetDropZone("uploadDropZone", "uploadDropZoneText", "Drag and drop a file here, or click to browse");
        ...
        function submitUpload() {
            ...
            if (!fileInput.files.length) {
                document.getElementById("fileError").textContent = "Please choose a file to upload.";
                return;
            }

            const formData = new FormData();
            formData.append("file", fileInput.files[0]);
            const customName = document.getElementById("upload_custom_name").value.trim();
            ...
            fetch(API, {
                ...
                .then(data => {
                    loadMedia();
                    uploadModal.hide();
                    document.getElementById("saveSuccessTitle").textContent = "Uploaded Successfully";
        ...
        function openEditModal(id) {
            ...
            document.getElementById("edit_original_name").value = item.original_name || "";
            document.getElementById("edit_file").value = "";

            resetDropZone("editDropZone", "editDropZoneText", "Drag and drop or click to replace file");
            ...
            if (isImage && item.url) {
                icon.innerHTML =
                    `<img src="${item.url}" alt="current" class="img-thumbnail mb-1" style="max-height:80px;">`;
            } else {
        ...
        function submitEdit() {
            ...
            const formData = new FormData();
            formData.append("original_name", document.getElementById("edit_original_name").value.trim());
            ...
            fetch(`${API}/${id}`, {
                ...
                .then(data => {
                    loadMedia();
                    editModal.hide();
                    document.getElementById("saveSuccessTitle").textContent = "Updated Successfully";
                    document.getElementById("saveSuccessMsg").textContent = data.message ||
        ...
        function executeDelete(id) {
            fetch(`${API}/${id}`, {
                ...
                .then(data => {
                    loadMedia();
                    document.getElementById("deleteSuccessMsg").textContent = data.message ||
