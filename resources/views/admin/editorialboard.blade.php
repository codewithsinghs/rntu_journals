    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="bottom-btn">
                    <button type="button" class="red" id="ebConfirmDeleteBtn">
                        <span id="ebDeleteSpinner" class="d-none">
                            <i class="spinner-border spinner-border-sm"></i>
                        </span>
                        <span id="ebDeleteLabel">Delete</span>
                    </button>
    ...
    <div id="ebToast" class="toast align-items-center text-white border-0" role="alert" aria-live="assertive"
        ...
        <div class="d-flex">
            <div class="toast-body d-flex align-items-center gap-2">
                <span id="ebToastIcon" style="color:white;"></span>
                <div>
                    <div id="ebToastTitle" class="fw-semibold" style="font-size:14px;color:white;"></div>
                    <div id="ebToastMsg" class="opacity-75" style="font-size:13px;color:white;"></div>
                </div>
            </div>
