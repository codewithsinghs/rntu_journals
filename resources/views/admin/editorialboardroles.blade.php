                ...
                <div class="modal-body">
                    ...
                    <div class="middle-3 middle">
                        ...
                        <span class="input-set">
                            ...
                            <input type="number" id="ebr_sequence" name="sequence" min="0" placeholder="0">
                            <div class="invalid-feedback" id="err_ebr_sequence"></div>
                        </span>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="bottom-btn">
                    <button type="button" class="red" id="ebrConfirmDeleteBtn">
                        <span id="ebrDeleteSpinner" class="spinner-border spinner-border-sm d-none me-1"></span>
                        <span id="ebrDeleteLabel">Delete</span>
                    </button>
